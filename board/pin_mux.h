...
/*! @name PIO0_16 (number 14), ENC
  @{ */
#define ENCODER_GPIO_CHA_INT_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENCODER_GPIO_CHA_INT_PIN 16U                   /*!<@brief PORT pin number */
#define ENCODER_GPIO_CHA_INT_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                                       /* @} */

/*! @name PIO0_15 (number 22), ENC
  @{ */
#define ENCODER_GPIO_SW_INT_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENCODER_GPIO_SW_INT_PIN 15U                   /*!<@brief PORT pin number */
#define ENCODER_GPIO_SW_INT_PIN_MASK (1U << 15U)      /*!<@brief PORT pin mask */
                                                      /* @} */
...
/* Symbols to be used with GPIO driver */
#define ENCODER_GPIO_SW_GPIO_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define ENCODER_GPIO_SW_GPIO_GPIO_PIN_MASK (1U << 15U) /*!<@brief GPIO pin mask */
#define ENCODER_GPIO_SW_GPIO_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENCODER_GPIO_SW_GPIO_PIN 15U                   /*!<@brief PORT pin number */
#define ENCODER_GPIO_SW_GPIO_PIN_MASK (1U << 15U)      /*!<@brief PORT pin mask */
                                                       /* @} */

/*! @name PIO0_23 (number 20), ENC
  @{ */

/* Symbols to be used with GPIO driver */
#define ENCODER_GPIO_CHB_GPIO_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define ENCODER_GPIO_CHB_GPIO_GPIO_PIN_MASK (1U << 23U) /*!<@brief GPIO pin mask */
#define ENCODER_GPIO_CHB_GPIO_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENCODER_GPIO_CHB_GPIO_PIN 23U                   /*!<@brief PORT pin number */
#define ENCODER_GPIO_CHB_GPIO_PIN_MASK (1U << 23U)      /*!<@brief PORT pin mask */
                                                        /* @} */
...
/* Symbols to be used with GPIO driver */
#define ENCODER_GPIO_CHA_GPIO_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define ENCODER_GPIO_CHA_GPIO_GPIO_PIN_MASK (1U << 16U) /*!<@brief GPIO pin mask */
#define ENCODER_GPIO_CHA_GPIO_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ENCODER_GPIO_CHA_GPIO_PIN 16U                   /*!<@brief PORT pin number */
#define ENCODER_GPIO_CHA_GPIO_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                                        /* @} */
 ...
 *
 */
void ENCODER_GPIO(void); /* Function assigned for the Cortex-M33 (Core #0) */
...
/*! @name PIO0_14 (number 72), FX1
  @{ */
#define OLED_I2C_SCL_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define OLED_I2C_SCL_PIN 14U                   /*!<@brief PORT pin number */
#define OLED_I2C_SCL_PIN_MASK (1U << 14U)      /*!<@brief PORT pin mask */
                                               /* @} */

/*! @name PIO0_13 (number 71), FX1
  @{ */
#define OLED_I2C_SDA_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define OLED_I2C_SDA_PIN 13U                   /*!<@brief PORT pin number */
#define OLED_I2C_SDA_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                               /* @} */
 ...
 *
 */
void OLED_I2C(void); /* Function assigned for the Cortex-M33 (Core #0) */
 ...
 *
 */
void PWM_GPIO(void); /* Function assigned for the Cortex-M33 (Core #0) */
